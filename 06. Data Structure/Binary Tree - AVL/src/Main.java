        ...
        while (i < request) {
            ...
            switch (statement) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    System.out.println("*** balance factor of nodes before balancing ***");
                    binarytree.printBalanceFactor(binarytree.getRoot());
                    binarytree.bstToAVL();
                    binarytree.isBalanced(binarytree.getRoot());
                    System.out.println("*** balance factor of nodes after balancing ***");
                    binarytree.printBalanceFactor(binarytree.getRoot());
                    break;
                default:
